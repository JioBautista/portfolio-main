      ...
      <div>
        ...
        <div className="p-5 space-y-1">
          ...
          <p>
            ...
            database. Core functionalities currently implemented include a fully
            functional shopping cart and checkout process. Future enhancements
            planned include email notifications upon successful checkout, user
            wishlists, secure login/signup functionality, and optimizations for
            performance and security.
          </p>

          <div className="flex justify-center gap-3 md:justify-end">
            <Link
              to={"https://github.com/JioBautista/audiophile-ecommerce-website"}
        ...
        <div>
          <div className="p-5 space-y-1">
            ...
            <p>
              ...
              randomly assigned flag, visible only to them – it's either red or
              green. The goal is to deduce which of your friends is the "red
              flag," leading to hilarious accusations and, of course, drinks!
              This app will be developed using React for a dynamic front-end,
              styled with Tailwind CSS for a clean and responsive design. The
              backend will be powered by Express.js, with WebSockets integrated
              to ensure seamless real-time updates and a truly interactive
              gaming experience.
            </p>
          </div>
        </div>
